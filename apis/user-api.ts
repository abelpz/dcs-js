...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        userCheckFollowing: async (follower: string, followee: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            assertParamExists('userCheckFollowing', 'follower', follower)
            // verify required parameter 'followee' is not null or undefined
            assertParamExists('userCheckFollowing', 'followee', followee)
         ...
         * @throws {RequiredError}
         */
        userCurrentTrackedTimes: async (since?: string, before?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async userCheckFollowing(follower: string, followee: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.userCheckFollowing(follower, followee, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async userCurrentTrackedTimes(since?: string, before?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TrackedTime>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.userCurrentTrackedTimes(since, before, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        userCheckFollowing(follower: string, followee: string, options?: any): AxiosPromise<void> {
            return localVarFp.userCheckFollowing(follower, followee, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary creates a new OAuth2 application
         ...
         * @throws {RequiredError}
         */
        userCurrentTrackedTimes(since?: string, before?: string, options?: any): AxiosPromise<Array<TrackedTime>> {
            return localVarFp.userCurrentTrackedTimes(since, before, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary delete an access token
...
export class UserApi extends BaseAPI {
     ...
     * @memberof UserApi
     */
    public userCheckFollowing(follower: string, followee: string, options?: AxiosRequestConfig) {
     ...
     * @memberof UserApi
     */
    public userCurrentTrackedTimes(since?: string, before?: string, options?: AxiosRequestConfig) {
