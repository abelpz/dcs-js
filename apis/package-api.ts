...
export const PackageApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listPackages: async (owner: string, page?: number, limit?: number, type?: 'composer' | 'conan' | 'container' | 'generic' | 'helm' | 'maven' | 'npm' | 'nuget' | 'pypi' | 'rubygems', q?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
...
export const PackageApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listPackages(owner: string, page?: number, limit?: number, type?: 'composer' | 'conan' | 'container' | 'generic' | 'helm' | 'maven' | 'npm' | 'nuget' | 'pypi' | 'rubygems', q?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Package>>> {
...
export const PackageApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listPackages(owner: string, page?: number, limit?: number, type?: 'composer' | 'conan' | 'container' | 'generic' | 'helm' | 'maven' | 'npm' | 'nuget' | 'pypi' | 'rubygems', q?: string, options?: any): AxiosPromise<Array<Package>> {
...
export interface PackageApiListPackagesRequest {
     ...
     * @memberof PackageApiListPackages
     */
    readonly type?: 'composer' | 'conan' | 'container' | 'generic' | 'helm' | 'maven' | 'npm' | 'nuget' | 'pypi' | 'rubygems'
...
export class PackageApi extends BaseAPI {
     ...
     * @memberof PackageApi
     */
    public deletePackage(requestParameters: PackageApiDeletePackageRequest, options?: AxiosRequestConfig) {
        return PackageApiFp(this.configuration).deletePackage(requestParameters.owner, requestParameters.type, requestParameters.name, requestParameters.version, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PackageApi
     */
    public getPackage(requestParameters: PackageApiGetPackageRequest, options?: AxiosRequestConfig) {
        return PackageApiFp(this.configuration).getPackage(requestParameters.owner, requestParameters.type, requestParameters.name, requestParameters.version, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PackageApi
     */
    public listPackageFiles(requestParameters: PackageApiListPackageFilesRequest, options?: AxiosRequestConfig) {
        return PackageApiFp(this.configuration).listPackageFiles(requestParameters.owner, requestParameters.type, requestParameters.name, requestParameters.version, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PackageApi
     */
    public listPackages(requestParameters: PackageApiListPackagesRequest, options?: AxiosRequestConfig) {
        return PackageApiFp(this.configuration).listPackages(requestParameters.owner, requestParameters.page, requestParameters.limit, requestParameters.type, requestParameters.q, options).then((request) => request(this.axios, this.basePath));
    }
}
