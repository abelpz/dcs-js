...
export class PackageApi extends BaseAPI {
     ...
     * @memberof PackageApi
     */
    public listPackages(owner: string, page?: number, limit?: number, type?: 'composer' | 'conan' | 'container' | 'generic' | 'helm' | 'maven' | 'npm' | 'nuget' | 'pypi' | 'rubygems', q?: string, options?: AxiosRequestConfig) {
